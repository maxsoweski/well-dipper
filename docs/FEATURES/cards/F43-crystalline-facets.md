...
- Defaults under-read at the implementer's amp 0.5 / scale 9 (facets nearly invisible —
  ...
  sits mid-range and stays walkable. Edits in `world-engine-lab.html` state defaults +
