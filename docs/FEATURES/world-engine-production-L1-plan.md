...
**Date:** 2026-06-23. **Repo:** `~/projects/well-dipper`, branch `master` (planning doc only — additive). **Status: PLANNING.**
Not yet `dev-collab-scope`'d, not built. This doc answers Max's two planning questions per workstream —
