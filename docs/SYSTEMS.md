...
graph LR
  ...
  app-shell --> worldengine
  generation --> worldengine
```
<!-- /AUTO-GENERATED -->
...
|---|---|---|---|
| app-shell | generation, worldengine | — | 📄 SYSTEMS/app-shell/ |
| generation | worldengine | — | 📄 SYSTEMS/generation/ |
| worldengine | — | generation | 📄 SYSTEMS/worldengine/ |
<!-- /AUTO-GENERATED -->
...
| generation | ⭐ **Umbrella slug for the whole procedural layer** — this is the slug `doc-graph.js` sees, and the deep dive covers instruments, corpora, draw-stream discipline and the dated-doc index for all four `generation-*` sub-slugs below | F&F-MVP | `src/generation/**` | 📄 [SYSTEMS/generation/](SYSTEMS/generation/README.md) |
| generation-galaxy | Galactic-scale procgen: galaxy structure, sectors, clusters, nebulae, navigable variants, milky-way model, hash-grid starfield | F&F-MVP | `src/generation/GalaxyGenerator.js`, `src/generation/GalacticMap.js`, `src/generation/GalacticSectors.js`, `src/generation/ClusterGenerator.js`, `src/generation/NebulaGenerator.js` | 📄 [SYSTEMS/generation/](SYSTEMS/generation/README.md) |
| generation-planet | Planet / moon / asteroid-belt procgen — physical units (AU, Earth radii) | F&F-MVP | `src/generation/PlanetGenerator.js`, `src/generation/MoonGenerator.js`, `src/generation/AsteroidBeltGenerator.js` | 📄 [SYSTEMS/generation/](SYSTEMS/generation/README.md) |
| generation-style | Naming, style-profile adaptation, exotic overlay, seeded RNG for generation determinism | F&F-MVP | `src/generation/NameGenerator.js`, `src/generation/StyleProfileAdapter.js`, `src/generation/ExoticOverlay.js`, `src/generation/SeededRandom.js` | 📄 [SYSTEMS/generation/](SYSTEMS/generation/README.md) + 📄 [NAMING_AND_REAL_OBJECTS.md](NAMING_AND_REAL_OBJECTS.md) |
| generation-system | Star system procgen: known systems (Sol + named), solar-system data, destination picker, system generator | F&F-MVP | `src/generation/StarSystemGenerator.js`, `src/generation/KnownSystems.js`, `src/generation/SolarSystemData.js`, `src/generation/DestinationPicker.js` | 📄 [SYSTEMS/generation/](SYSTEMS/generation/README.md) + 📄 [NAMING_AND_REAL_OBJECTS.md](NAMING_AND_REAL_OBJECTS.md) |
...
| rendering-shaders | Shared shader modules: material-body shader, textured-body shader | F&F-MVP | `src/rendering/shaders/MaterialBodyShader.js`, `src/rendering/shaders/TexturedBodyShader.js` | — no doc yet |
