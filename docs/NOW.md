...
> **▶▶ ACTIVE (2026-07-21 — both campaign UATs ran: NEITHER shipped, verdicts filed (`4b62bf4`/`6d743dc`); Crystal RULED defer (clause struck); Inc-3 + depth-law BUILT SAME DAY → ★ VERIFIED_PENDING_MAX `f524fd9`; Max's gate = terrain re-UAT).**
