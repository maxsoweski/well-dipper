...
> ## ▶ **HANDOFF = `docs/FEATURES/handoff-2026-09-08-resolution-revisions.md`. START THERE.** Max asked the next session to OPEN with an overall recap of the resolution revisions — §0 of that file says how. ⛔ Do not open by asking what to work on.
