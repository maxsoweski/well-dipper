...
> 1. **"The rivers are not fully developed" — say what you saw, in your words,** so it can be scoped: too thin / too few / no visible deltas or sea / they do not keep resolving as you fly in / something else. Candidates already on the books: QB-21 (every wet world gets the same 35 % ocean), QB-22 (per-body admission), QB-23 (F13 saturates), the view-dependent river LOD (`uRiverCarvePatchMap`, out of this workstream's scope), and the small-body width law. Nothing is scoped until you name it.
