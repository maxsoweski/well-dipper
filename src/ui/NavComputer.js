...
export class NavComputer {
  constructor(canvas, galacticMap, webglRenderer) {
    ...
    this._dragStartX = 0;
    this._dragStartY = 0;  this._dragStartLadder = null;   /* ⭐ AC-7: the drag-start snapshot of `S.ladderScroll`, mirroring `_panStartCenter` (:4409) for the 2D pan. `null` means "this gesture is not a ladder pan", which is every gesture outside design 1 at SYSTEM. */
