...
//    src/objects/Planet.js:2048 `const zeroFilled = ensureLabAttributes(geometry);` still supplies
...
// It belongs next to src/objects/Planet.js:2208 `export const GAME_ANIM_RATE = 1.0;` with the other
