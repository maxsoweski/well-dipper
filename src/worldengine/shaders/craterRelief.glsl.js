...
void craterEjectaCombiner(vec3 dir, inout float h, inout vec3 slope){
  ...
  // THIS LINE HAS A TWIN AND NOTHING PINS THEM TOGETHER. the lab's craterCombiner at src/worldengine/shaders/height.glsl.js:2248 carries the identical
  ...
  // below, and that whole family is an open A/B for Max (a ~113x change); folding a size term into
