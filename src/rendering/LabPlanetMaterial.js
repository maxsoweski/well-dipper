 ...
 *
 * @param {{lightDir?: THREE.Vector3|number[]}} [opts]
 * @returns {{material: THREE.ShaderMaterial, uniformCount: number, lightDir: number[]}}
 */
export function buildLabPlanetMaterial(opts = {}) {
  ...
  return { material, uniformCount: Object.keys(uniforms).length, lightDir: light.toArray() };
}
