...
// ── BAKED-RELIEF: the HEIGHT cube (WS world-engine-baked-relief-render-2026-06-25, Phase B) ─────
// MOVED 2026-09-02 to src/rendering/bake/heightCube.js, BYTE-VERBATIM (this section's banner plus
// RELIEF_CUBE_SIZE, buildHeightCubeGeometry, createHeightCube, bakeHeightCube), so the GAME can bake
// the relief cube its shader already samples — nothing under src/ may import this root module.
// GPU-coupled (WebGLCubeRenderTarget + CubeCamera) ⇒ src/rendering/bake/ under carried C25, exactly
// as the province cube went on 2026-09-01. Imported back and RE-EXPORTED so planet-lod-rivers.js and
// the lab keep this import path (the bodyRelief.js precedent).
import { RELIEF_CUBE_SIZE, buildHeightCubeGeometry, createHeightCube, bakeHeightCube } from './src/rendering/bake/heightCube.js';
export { RELIEF_CUBE_SIZE, buildHeightCubeGeometry, createHeightCube, bakeHeightCube };

// ── PROVINCE CUBE (V2-4 province → GPU) ─────────────────────────────────────────────────────────
// MOVED 2026-09-01 to src/rendering/bake/provinceCube.js, BYTE-VERBATIM (PROVINCE_CUBE_SIZE,
// buildProvinceCubeGeometry, createProvinceCube, bakeProvinceCube), so the GAME can bake the cube
// its shader already samples — nothing under src/ may import this root module. GPU-coupled
// (WebGLCubeRenderTarget + CubeCamera) ⇒ src/rendering/bake/ under carried C25. Imported back and
// RE-EXPORTED so planet-lod-rivers.js and the lab keep this import path (the bodyRelief.js precedent).
import { PROVINCE_CUBE_SIZE, buildProvinceCubeGeometry, createProvinceCube, bakeProvinceCube } from './src/rendering/bake/provinceCube.js';
export { PROVINCE_CUBE_SIZE, buildProvinceCubeGeometry, createProvinceCube, bakeProvinceCube };
